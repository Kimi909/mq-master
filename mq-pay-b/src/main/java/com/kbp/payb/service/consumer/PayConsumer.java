package com.kbp.payb.service.consumer;

import com.kbp.payb.constants.Const;
import com.kbp.payb.entity.PlatformAccount;
import com.kbp.payb.mapper.PlatformAccountMapper;
import com.kbp.payb.utils.FastJsonConvertUtil;
...
public class PayConsumer {
	...
	private PayConsumer() {
		try {
			...
			this.consumer.setNamesrvAddr(Const.NAMESRV_ADDR_MASTER_SLAVE);
